        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              ...
              <p>
                <strong className="text-gray-800">What are cookies?</strong> Cookies are small text files stored on your
              ...
              <p>
                <strong className="text-gray-800">Types of cookies we use:</strong>
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong className="text-gray-800">Essential cookies:</strong> Required for the website to function
                  properly. These cannot be disabled.
                </li>
                <li>
                  <strong className="text-gray-800">Analytics cookies:</strong> Help us understand how visitors interact
                  with our website by collecting and reporting information anonymously.
                </li>
                <li>
                  <strong className="text-gray-800">Functional cookies:</strong> Enable enhanced functionality and
                  personalisation, such as remembering your preferences.
                </li>
              </ul>
              <p>
                <strong className="text-gray-800">Managing cookies:</strong> You can control and manage cookies through
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              ...
              <div className="bg-gray-50 rounded-lg p-6 border border-gray-100">
                <p className="mb-1">
                  ...
                  <a href="mailto:legal@innovaas.co"
                     style={{ color: '#F25C05' }}
                     className="underline decoration-transparent
                                hover:decoration-current transition-all">
                    legal@innovaas.co
